<template>
    <div class="container-fluid">
        ...
        <p class="pt-4"
           style="text-align:center; letter-spacing:1.5px">
            <strong>Bejelentkezés:</strong> 16.00-21.00 óra között. Későbbi érkezést kérjük előre jelezni!
            <br />
            <strong>Kijelentkezés:</strong> 10.00 óráig. 10.00-12.00 közötti kijelentkezés esetén a szálloda
            jogosult a mindenkori napi ár 50%-át, ez időn túl pedig a napi ár 100%-át pótdíjként felszámítani.
        </p>
        <p class="pt-4"
           style="text-align:center; letter-spacing:1.5px">
